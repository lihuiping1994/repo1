                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            <select class="form-control" id="changePageSize" onchange="changePageSize()">
                                <c:forEach begin="1" end="5" varStatus="pageSize">
                                    <option value="${pageSize.index}" <c:if test="${pageInfo.size eq pageSize.index}">selected="selected"</c:if>>${pageSize.index}</option>
                                </c:forEach>

                            <%--    <option value="1" <c:if test="${pageInfo.size eq '1'}">selected="selected"</c:if>>1</option>
                                <option value="2" <c:if test="${pageInfo.size eq '2'}">selected="selected"</c:if>>2</option>
                                <option value="3" <c:if test="${pageInfo.size eq '3'}">selected="selected"</c:if>>3</option>
                                <option value="4" <c:if test="${pageInfo.size eq '4'}">selected="selected"</c:if>>4</option>
                                <option value="5" <c:if test="${pageInfo.size eq '5'}">selected="selected"</c:if>>5</option>--%>
                            </select> 条
                        </div>
                    </div>
